class User < ActiveRecord::Base
  ...
  attr_accessible :name, :email, :username, :last_seen, :avatar_url, :avatar, :profile, :contacts, :note, :points, :pref_payment, :rate, :resume, :type, :views, :website, :skills_attributes, :skill_ids, :credentials, :credentials_attributes, :credential_ids, :availability
  accepts_nested_attributes_for :credentials, :reject_if => lambda { |a| a[:content].blank? }, :allow_destroy => true
